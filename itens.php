...
<body>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="adicionar-body" class="panel-body">
                            <div class="row">
                                <form id="adicionar-item" role="form">
                                    <div class="form-group col-lg-4">
                                     ...
                                     <div class="form-group col-lg-7">
                                        <label>Lote</label>
                                        <select id="lote" name="lote" class="form-control" data-placeholder="selecione um lote...">
                                            <option></option>                                                        
                                        </select>
                                    </div>
    ...
    <script src="js/registroembarcado.itens.js"></script>
