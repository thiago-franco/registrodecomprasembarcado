...
<body>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="adicionar-body" class="panel-body">
                            <div class="row">
                                <form id="adicionar-lote" role="form">
                                    ...
                                    <div class="form-group col-lg-5">
                                        <label>Produto</label>
                                        <select id="produto" name="produto" class="form-control" data-placeholder="selecione um produto..." > 
                                        	<option></option>   
                                        </select>
                                    </div>
                                     <div class="form-group col-lg-3">
                        	...
                        	<div class="row">
                            	<div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table id="tabela-lotes" class="table table-bordered">
    ...
    <script src="js/registroembarcado.lotes.js"></script>
